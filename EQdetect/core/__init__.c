...
#define __pyx_kp_u_EQdetect_core___init __pyx_string_tab[1]
...
#define __pyx_n_u_sourcecal __pyx_string_tab[8]
...
__Pyx_RefNannySetupContext("PyInit_core", 0);
  ...
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_EQdetect_core___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
 ...
 * from .sourcecal import *             # <<<<<<<<<<<<<<
*/
  __pyx_t_2 = __Pyx_PyList_Pack(1, __pyx_mstate_global->__pyx_n_u_); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_sourcecal, __pyx_t_2, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 1, __pyx_L1_error)
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_EQdetect_core___init, sizeof(__pyx_k_EQdetect_core___init), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_EQdetect_core___init */
  ...
  {__pyx_k_sourcecal, sizeof(__pyx_k_sourcecal), 0, 1, 1}, /* PyObject cname: __pyx_n_u_sourcecal */
